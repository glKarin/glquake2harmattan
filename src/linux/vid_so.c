...
vidmode_t vid_modes[] =
{
	...
	{ "Mode 15: 800x480",    800,  480, 15 }, /* as found modern */
	...
	{ "Mode 20: 854x480",    854,  480, 20 }, /* MeeGo Harmattan */
};
...
#ifdef _HARMATTAN
	Com_Printf("[karin]: Connect Q2 event binding......");
	re.KarinSetKeyBindinds(keybindings);
	re.KarinSetAddCommandFunction(Cbuf_AddText);
	Com_Printf("Done\n");
#endif
...
void IN_Shutdown (void)
{
	if (RW_IN_Shutdown_fp)
		RW_IN_Shutdown_fp();
#ifdef _HARMATTAN
	Com_Printf("[karin]: Disconnect Q2 event binding......");
	re.KarinSetKeyBindinds(NULL);
	re.KarinSetAddCommandFunction(NULL);
	Com_Printf("Done\n");
#endif
