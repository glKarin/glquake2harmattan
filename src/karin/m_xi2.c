...
#define VID_WIDTH (vid.width)
#define VID_HEIGHT (vid.height)
...
static MultiMouseEvent_Function mouseHandler = NULL;
static MultiMotionEvent_Function motionHandler = NULL;
...
#define MAXMOUSE 10
#define MOUSE_MAX_X (VID_WIDTH - 1)
#define MOUSE_MAX_Y (VID_HEIGHT - 1)
...
static int X11_XInput2_DispatchTouchDeviceEvent(XIDeviceEvent *e)
{
	...
	const int screen_w = VID_WIDTH;
	const int screen_h = VID_HEIGHT;
